...
var ASM_CONSTS = {
  5509124: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 5509179: ($0) => { performance.now = function() { return $0; }; },  
 5509227: ($0) => { performance.now = function() { return $0; }; },  
 5509275: () => { performance.now = Module['emscripten_get_now_backup']; }
};
